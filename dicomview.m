...
%   DICOMVIEW('dir') opens a series of dicom images from a single
%   directory 'dir'. It creates a GUI with a slider for imagenumber and
%   image information displayed underneath. Other sliders can be used to
%   threshold the image and find contours of same intensity objects. The
%   3D image with thresholding values can be stored in the workspace for
%   further processing.
%
